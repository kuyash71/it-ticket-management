...
| Service Request approval kapısı | Tasarım Bölüm 2.4 | `apps/api/src/modules/tickets/application/use-cases/change-status.use-case.ts`, `apps/api/src/modules/tickets/domain/models/ticket.ts` | In Progress | Sprint 7 |
